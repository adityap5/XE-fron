          ...
          <div className="hidden sm:ml-6 sm:flex sm:items-center">
            {isAuthenticated ? (
              <button
                ...
                className="text-gray-500 hover:text-gray-700 inline-flex items-center px-4 py-2 text-sm font-medium rounded-md"
              >
                Logout
              </button>
            ) : (
              <div className="space-x-4">
                ...
                <Link
                  to="/register"
                  className="bg-green-600 text-white hover:bg-green-700 inline-flex items-center px-4 py-2 text-sm font-medium rounded-md"
                >
                  Register
                </Link>
              </div>
        ...
        <div className="flex flex-col items-center space-y-4">
          ...
          {isAuthenticated ? (
            ...
            <div className="space-x-4">
              ...
              <Link
                to="/register"
                className="bg-green-600 text-white p-2 rounded-lg hover:bg-green-700 text-xl"
                onClick={() => setIsMenuOpen(false)}
              >
                Register
              </Link>
